// Vendored from React Bits (https://reactbits.dev/backgrounds/dark-veil), adapted to this app's conventions.
...
/** An ambient, hue-shifting veil — every effect defaults to off/zero except a slow drift, so it's subtle out of the box. No mouse interaction. */
