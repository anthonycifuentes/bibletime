// Vendored from React Bits (https://reactbits.dev/backgrounds/silk), adapted to this app's conventions.
...
/** A slow, cloth-like ambient shader background — no mouse interaction. */
